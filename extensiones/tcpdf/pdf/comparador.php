    ...
    if ($cont26 % 2 == 0) {
        if ($PT == "Deducible: 10% min 1.2 SMMLV" || $PT == "Deducible: 10% min 1 SMMLV") {
            ...
            if ($rowRespuestaAsistencia22['GastosMedicos'] == "Si ampara") {
                ...
                $html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center; font-family:dejavusanscondensed;"><div style="font-size:7pt">&nbsp;</div>' . $rowRespuestaAsistencia22['GastosMedicos'] . '</font></center></td>';
            }
        }
    } else {
        if ($PT == "Deducible: 10% min 1 SMMLV" || $PT == "Deducible: 10% min 1.2 SMMLV") {			
            ...
            if ($rowRespuestaAsistencia22['GastosMedicos'] == "Si ampara") {
                ...
                $html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center; font-family:dejavusanscondensed;"><div style="font-size:7pt">&nbsp;</div>' . $rowRespuestaAsistencia22['GastosMedicos'] . '</font></center></td>';
            }
        }
    }
