...
while ($rowRespuesta23 = mysqli_fetch_assoc($respuestaquery23)) {
	...
	if ($cont21 % 2 == 0) {
		...
		// } else {
		$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center; font-family:dejavusanscondensed;"><div style="font-size:14pt">&nbsp;</div>' . $ampara . '</font></center></td>';
		// }
	} else {
		// if ($rowRespuestaAsistencia17['ResponsabilidadCivilGeneralFamiliar'] == "Si ampara") {
		// $html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:12pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		// } else {
		$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center; font-family:dejavusanscondensed;"><div style="font-size:14pt">&nbsp;</div>' . $ampara . '</font></center></td>';
	}
...
while ($rowRespuesta27 = mysqli_fetch_assoc($respuestaquery27)) {
	...
	if ($cont25 % 2 == 0) {
		if ($rowRespuestaAsistencia21['exequias'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center; font-family:dejavusanscondensed;"><div style="font-size:14pt">&nbsp;</div>' . $rowRespuestaAsistencia21['exequias'] . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia21['exequias'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:6pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		} else {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center; font-family:dejavusanscondensed;"><div style="font-size:14pt">&nbsp;</div>' . $rowRespuestaAsistencia21['exequias'] . '</font></center></td>';
		}
	}
    ...
    if ($cont26 % 2 == 0) {
        if ($PT == "Deducible: 10% min 1.2 SMMLV" || $PT == "Deducible: 10% min 1 SMMLV") {
            ...
            if ($rowRespuestaAsistencia22['GastosMedicos'] == "Si ampara") {
                ...
                $html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center; font-family:dejavusanscondensed;"><div style="font-size:14pt">&nbsp;</div>' . $rowRespuestaAsistencia22['GastosMedicos'] . '</font></center></td>';
            }
        }
    } else {
        if ($PT == "Deducible: 10% min 1 SMMLV" || $PT == "Deducible: 10% min 1.2 SMMLV") {			
            ...
            if ($rowRespuestaAsistencia22['GastosMedicos'] == "Si ampara") {
                ...
                $html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center; font-family:dejavusanscondensed;"><div style="font-size:14pt">&nbsp;</div>' . $rowRespuestaAsistencia22['GastosMedicos'] . '</font></center></td>';
            }
        }
    }
...
while ($rowRespuesta28 = mysqli_fetch_assoc($respuestaquery28)) {
	...
	if ($cont26 % 2 == 0) {
		if ($rowRespuestaAsistencia22['LucroCesante'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['LucroCesante'] . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia22['LucroCesante'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:6pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		} else {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['LucroCesante'] . '</font></center></td>';
		}
	}
