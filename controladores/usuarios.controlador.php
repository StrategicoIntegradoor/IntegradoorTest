			...
			if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingUsuario"])){
				...
				if($respuesta["usu_usuario"] == $_POST["ingUsuario"] && $respuesta["usu_password"] === $encriptar ){
					...
					echo '<script>
								Swal.fire({
									html:  `
									<div style="text-align: justify; font-family: Helvetica, Arial, sans-serif; font-size: 15px; border-radius: 75px;">
										...
										<br><br>
										Si por el contrario, no estas interesado en vender seguros por medio de Grupo Asistencia como aliado,👉🏽pero si te interesa tener tu propia versión personalizada del software para generar cotizaciones y cuadros comparativos (incluyendo tu propio logo), comunícate con nosotros, Strategico Technologies, desarrolladores de esta plataforma, para conocer acerca de los planes de pago, que inician desde los $1.950 pesos por placa cotizada.										<br><br><br>
								...
								`,
									...
									window.location.href = "integradoor.com/App"; // Redirigir después de cerrar SweetAlert
								});
							</script>';
