...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini login-page">
  ...
  if (isset($_SESSION["iniciarSesion"]) && $_SESSION["iniciarSesion"] == "ok") {
    ...
    echo '<input type="hidden" id="rolId" value="'.$_SESSION["rol"].'">';
...
echo'<a href="https://api.whatsapp.com/send/?phone=573153539141&text=Hola Strategico&app_absent=0" target="_blank" class="btn-wasap" style="float: unset; position: fixed; z-index: 999; bottom: 4%; left: 2%;">
