    ...
    <section class="content">
        <div class="box">
                ...
                <div class="content">
                        ...
                        <div class="col-md-4 col-sm-12" style="margin-top: -20px;">
                            <div class="login-logo d-flex justify-content-center align-items-center">
                                ...
                                <div class="text" style="text-align: justify;">
                                    <p style="margin-bottom: 10px; margin-top: 10px; font-size: 15px; font-family: 'Arial Arabic', Arial, sans-serif; margin-left: 15px;"><i class="fas fa-check" style="color: #82d600;"></i> La mejor y más grande red de servicios exequiales en Colombia</p>
                                    <p style="margin-bottom: 10px; margin-top: 10px; font-size: 15px; font-family: 'Arial Arabic', Arial, sans-serif; margin-left: 15px;"><i class="fas fa-check" style="color: #82d600;"></i> 47 años creando experiencias memorables para las familias</p>
                                    <p style="margin-bottom: 10px; margin-top: 10px; font-size: 15px; font-family: 'Arial Arabic', Arial, sans-serif; margin-left: 15px;"><i class="fas fa-check" style="color: #82d600;"></i> Cumplimiento de promesa del producto garantizada</p>
                                    <p style="margin-bottom: 10px; margin-top: 10px; font-size: 15px; font-family: 'Arial Arabic', Arial, sans-serif; margin-left: 15px;"><i class="fas fa-check" style="color: #82d600;"></i> Cubrimiento del 100% del territorio Colombiano</p>
                                </div>
                            </div>
                        </div>
                        <!-- //PLAN MUY PERSONAL// -->
                        ...
                        <div class="col-md-4 col-sm-12" style="text-align: center;">
                            <div class="rounded-container">
                                ...
                                <br>
                                <p style="margin-bottom: 0px; margin-top: 0; font-size: 15px; font-family: 'Arial Arabic', Arial, sans-serif;">2 Beneficiarios hasta 72 años (Padres o suegros)</p>
                                <p style="margin-bottom: 0px; margin-top: 0; font-size: 15px; font-family: 'Arial Arabic', Arial, sans-serif;">4 Beneficiarios hasta 55 años (Hijos, Hermanos,</p>
                                <p style="margin-bottom: 0px; margin-top: 0; font-size: 15px; font-family: 'Arial Arabic', Arial, sans-serif;">Nietos, Cónyuge)</p>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="content">
                    <div class="content-header">
                        <h4 style="font-family: 'Arial Arabic', Arial; text-align: left; font-weight: bold; margin-bottom: -12px; margin-top: -8px;">Adicionales planes</h4>
                        <HR>
                    </div>
                    <div class="col-md-4 col-sm-12" style="text-align: center;  margin-bottom: 7px;">
                        <div class="rounded-container">
                            <div class="row">
                                <div class="col-md-6 col-sm-6" style="margin-left: 15px;">
                                    <div class="circle" style="position: relative; top: 3px;">
                                        <img src="vistas/img/plantilla/afiliado_adicional.jpg">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6" style="margin-left: 180px; margin-top: -120px;">
                                    <h4 style="margin-bottom: 5px;  font-family: 'Arial Narrow OS Bold', Arial, sans-serif; font-size: 15px;"><strong>AFILIADO ADICIONAL</strong></h4>
                                    <h3><strong style="color: #82d600;">$ 72.000</strong></h3>
                                    <p style="margin-bottom: 5px; margin-top: 0;">Pago anual</p>
                                    <br>
                                </div>         
                            ...
                            <p style="margin-bottom: 20px; margin-top: 0; font-size: 15px; font-family: 'Arial Arabic', Arial, sans-serif;">restricción de parentesco</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12" style="text-align: center;  margin-bottom: 7px;">
                        <div class="rounded-container">
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 form-group" style="margin-bottom: 0;">
                        ...
                        <input type="text" class="form-control" id="edadTitularID" required placeholder="Edad Titular">
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 form-group" style="margin-bottom: 0;">
