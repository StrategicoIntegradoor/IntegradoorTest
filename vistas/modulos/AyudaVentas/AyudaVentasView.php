                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dt-responsive tablas-asistencias" style="width: 100%;">
                        ...
                        <thead style="background: #88d600; color: #FFF; ">
                            <tr>
                                <th style="width: 2%; text-align: center">Aseguradora</th>
                                <th style="width: 2%; text-align: center">Linea de atención</th>
                                <th style="width: 15%; text-align: center">Clausulado</th>
                                <th style="width: 3%; text-align: center">Sarlaft PN</th>
                                <th style="width: 3%; text-align: center">Sarlaft PJ</th>
