...
const obtenerAyudaVentas = async () => {
    ...
    .then(data => {
        ...
        data.forEach(ayudaVenta => {
            ...
            let partTemplate = `
                <tr >
                    <td style="text-align: center;"><ul style="margin-top: 60px;"><img src="./vistas/modulos/AyudaVentas/src/logos/${ayudaVenta.aseguradora}.png" class="img-responsive" width="80" style="margin: 0 auto;"></ul></td>
            ...
            <style>
                ...
                <td class="fixed-width" style="min-width: 160px;">${construirHtmlContinuidad(continuidades)}</td>
                <td class="fixed-width" style="min-width: 160px;">${construirHtmlCambioIntermediario(cambioPoliticas)}</td>
