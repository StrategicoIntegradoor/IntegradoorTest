    ...
    .then(data => {
        ...
        data.forEach(ayudaVenta => {
            ...
            .continuidades {
                ...
                <td class="centros-de-inspeccion-cell" style="width: 14%; white-space: nowrap; text-align: center;">${construirHtmlCentrosDeInspeccion(centrosDeInspeccion)}</td>
                <td class="continuidades" style="width: 14%; white-space: nowrap; text-align: center;">${construirHtmlContinuidad(continuidades)}</td>
                <td class="formas-de-pago-cell" style="width: 14%; white-space: nowrap; text-align: center;">${construirHtmlFormasDePago(formasDePago)}</td>`
