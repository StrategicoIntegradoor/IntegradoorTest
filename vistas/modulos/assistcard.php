        ...
        <div class="box">
            <div class="row card-container">
                ...
                <div class="content" style="margin-top: -5px; margin-bottom: 5px">
                    ...
                    <div style="background-image: url('vistas/img/plantilla/banner_viajes.png'); height: 200px; width: 700px; background-size: cover; background-position: center;  margin: 0 auto;"></div>
