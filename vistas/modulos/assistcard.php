        ...
        <div class="box">
            <div class="row card-container">
                ...
                <div class="content">
                    ...
                    <!-- //LOGO Y DESCRIPCIÓN// -->
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            <div class="card-exequias-logo special-card">
                                <div class="card-body">
                ...
                <div class="content" style="margin-top: -5px; margin-bottom: 5px">
                    ...
                    <div style="background-image: url('vistas/img/plantilla/logo_assistcard.jpg'); height: 200px; width: 100%; background-size: cover; background-position: center; position: absolute; top: 100;"></div>
