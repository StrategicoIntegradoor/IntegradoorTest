        ...
        <div class="box">
            <div class="row card-container">
                ...
                <div class="content" style="margin-top: -5px; margin-bottom: 5px">
                    ...
                    <div style="background-image: url('vistas/img/plantilla/logo_assistcard.jpg'); height: 200px; background-size: cover; background-position: center;" class="width=100%;"></div>
