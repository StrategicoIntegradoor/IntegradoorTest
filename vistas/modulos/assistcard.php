...
.card-exequias {
  flex: 0 1 calc(30% - 10px); /* 48% es solo un ejemplo, ajusta según tus necesidades */
  border-radius: 20px;
  background-color: white;
  box-shadow: 0 0 5px rgba(0, 0, 0, 0.3);
  padding: 9%;
                    ...
                    <!-- //LOGO Y DESCRIPCIÓN// -->
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            <div class="card-exequias special-card">
                                <div class="card-body">
                                    <img src="vistas/img/plantilla/logo_assistcard.jpg" class="img-fluid mx-auto" style="max-width: 109%;">
                                </div>
                            </div>
                        </div>
            ...
            <!-- <div class="row"> -->
                <div class="content">
                    <!-- <div class="col-md-4 col-sm-12 mb-3"> -->
                        ...
                        <h4 style="font-family: 'Arial Arabic', Arial; font-weight: bold; margin-bottom: 3px; margin-top: 3px; margin-left: 3.33333%;">Solicita una cotización en el siguiente formulario</h4>
                        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdNXEYeuq8L5G15BQpGNKKt12cs7jzGvxYuqw2gdQaIH3qwGw/viewform?embedded=true" width="100%" height="1400" frameborder="0" marginheight="0" marginwidth="0">Cargando…</iframe>
                </div>
            <!-- </div> -->
