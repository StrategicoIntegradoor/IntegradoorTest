                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            <div class="card-exequias">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <p class="card-text">Para conocer más sobre Assist Card, ingresa <a href="https://Grupoasistencia.com/pdfExequias/PRESENTACION_CORPORATIVA_ASSIST_CARD.pdf" target="_blank">AQUI</a></p>
                                </div>
                            </div>
                        </div>
                    <!-- </div> -->
